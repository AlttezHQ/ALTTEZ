...
function decodeEventTitle(eventId) {
  // Si parece un ID estructurado de ALTTEZ (t-YYYY-M-N, m-YYYY-M-N, c-YYYY-M-N)
...
function useEventData(clubId, eventId) {
...

  {
    ...
    // Por ahora ALTTEZ usa localStorage para eventos — el eventId es suficiente.
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        ALTTEZ — Sistema de Gestion Deportiva
      </div>
