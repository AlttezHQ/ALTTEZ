 ...
 * @description Pagina de producto dedicada para ALTTEZ CRM.
 * Ruta: /servicios/sports-crm
 * NO es un resumen — es la pagina de producto completa.
 * Incluye sección "Así se ve ALTTEZ" con mini-previews CSS/SVG del UI real.
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", padding: "8px 12px", gap: 12 }}>
        ...
        {/* Top scorers */}
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 6, color: "rgba(255,255,255,0.25)", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 6 }}>Top ALTTEZ Score</div>
          {[
...
const PREVIEW_SLIDES = [
  ...
  },
  {
    id: "matchcenter",
    title: "Match Center",
    description: "Estadísticas post-partido con ALTTEZ Score propio. Spider chart por jugador, recomendaciones automáticas y cruce de datos con fatiga acumulada.",
    tag: "Match Center",
    tagColor: "#00e5ff",
          ...
          >
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: 7, color: "rgba(255,255,255,0.2)" }}>alttez.co/crm</div>
              </div>
            </div>
            <ActivePreview />
          </motion.div>
...
export default function SportsCRMPage() {
  ...
  usePageTitle("ALTTEZ CRM — El producto");
  ...
  return (
    <div style={{ overflowX: "hidden" }}>
      ...
      {/* ── Product Previews — "Así se ve ALTTEZ" ── */}
      ...
      <section className="scrm-bottom-cta" style={{
        ...
        <p style={{
          ...
          Accede al entorno demo y experimenta en minutos lo que ALTTEZ hace por la
