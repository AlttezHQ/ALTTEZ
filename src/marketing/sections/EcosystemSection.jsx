 ...
 * @description Grid 3D de paneles elevados — cada uno representa un proyecto/servicio de ALTTEZ.
    ...
    <section ref={ref} className="eco-section" style={{ padding: "100px 24px", maxWidth: 1100, margin: "0 auto" }}>
      ...
      >
        ...
        <p style={{
          ...
          ALTTEZ construye herramientas que transforman el deporte colombiano.
