  ...
  return (
    <div style={{ minHeight:"100vh", background:"#060d06", position:"relative" }}>
      ...
      <div style={{ position:"relative", zIndex:2 }}>
        ...
        {/* CONTENIDO */}
        {activeModule === "home" && (
          <Home club={{ ...clubInfo, categoria:(clubInfo.categorias||[])[0]||"Sub-17" }} athletes={athletes} historial={historial} stats={stats} onNavigate={setActiveModule} />
        )}
