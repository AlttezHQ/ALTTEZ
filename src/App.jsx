...
function Reportes({ athletes, historial, matchStats, finanzas, onNavigate }) {
  ...
  const kpiCards = [
    ...
    },
    {
      ...
      trend: 0,
      trendDisplay: `${athletes.filter(a=>a.status==="L").length} lesionados`,
    },
  ];
  ...
  return (
    <div style={{ padding:"20px 16px", maxWidth:900, margin:"0 auto" }}>
      ...
      <div className="rep-bottom-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:16 }}>
        ...
        >
          <div style={{ fontSize:9, textTransform:"uppercase", letterSpacing:"2px", color:"rgba(255,255,255,0.3)", marginBottom:14 }}>Record de partidos</div>
        ...
        <div
          ...
          style={{ background:"rgba(255,255,255,0.03)", backdropFilter:"blur(16px)", WebkitBackdropFilter:"blur(16px)", border:`1px solid rgba(255,255,255,0.08)`, borderRadius:12, padding:18, boxShadow:"0 4px 20px rgba(0,0,0,0.35)", cursor:"pointer" }}
        >
          <div style={{ fontSize:9, textTransform:"uppercase", letterSpacing:"2px", color:"rgba(255,255,255,0.3)", marginBottom:14 }}>Resumen financiero</div>
          <div style={{ display:"flex", gap:20, alignItems:"flex-end" }}>
            <div>
