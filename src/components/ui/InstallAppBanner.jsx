...
const IOS_STEPS = [
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <rect x="4" y="4" width="16" height="16" rx="3" stroke="#7c3aed" strokeWidth="1.5" />
        <path d="M12 8v8M8 12h8" stroke="#7c3aed" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    ),
  ...
  },
  {
    ...
    hint: "Elevate Sports aparecerá en tu pantalla de inicio como una app nativa.",
  },
];
      ...
      <>
        <AnimatePresence>
          <motion.button
            ...
            aria-label="Instalar Elevate Sports"
          >
            <DownloadIcon />
            Instalar App
          </motion.button>
