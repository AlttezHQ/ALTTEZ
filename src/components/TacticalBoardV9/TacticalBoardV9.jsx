...
export default function TacticalBoardV9({ athletes = [], historial = [], clubId = "" }) {
  ...
  const [rolesData, setRolesData] = useLocalStorage(`elevate_roles_v2${ns}`, {});
  const [instructionsText, setInstructionsText] = useLocalStorage(`elevate_instructions${ns}`, "");
  const [tacticasText, setTacticasText] = useLocalStorage(`elevate_tacticas${ns}`, "");
