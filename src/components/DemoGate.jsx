/**
 * @component DemoGate
 * @description Gate de conversión para el modo demo de Elevate Sports.
 *
...
const DEMO_START_KEY = "elevate_demo_start";
    ...
    >
      ...
      <div style={{ flex: 1, fontSize: 11, color: C.textMuted, minWidth: 0 }}>
        {expired
          ...
          : `Estás en el entorno demo de Elevate Sports. Tiempo restante: `
        }
        {!expired && (
          <span style={{
