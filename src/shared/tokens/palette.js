export const PALETTE = {
  ...
  bronceHi: "#D8A06B",
  bronceDeep: "#B7832D",
  bronceDim: "rgba(206, 137, 70, 0.12)",
  bronceBorder: "rgba(206, 137, 70, 0.28)",
  bronceGlow: "rgba(206, 137, 70, 0.18)",
  bronceFocus: "rgba(206, 137, 70, 0.34)",
  bronceIce: "#F6F1EA",

  blue: "#CE8946",
  blueHi: "#D8A06B",
  blueDeep: "#B7832D",
  blueDim: "rgba(206, 137, 70, 0.12)",
  blueBorder: "rgba(206, 137, 70, 0.28)",
  blueGlow: "rgba(206, 137, 70, 0.18)",
  ...
  success: "#2FA56F",
  successDim: "rgba(47,165,111,0.10)",
  successBorder: "rgba(47,165,111,0.24)",

  amber: "#D89A2B",
  amberDim: "rgba(216,154,43,0.10)",
  amberBorder: "rgba(216,154,43,0.24)",

  danger: "#D95C5C",
  dangerDim: "rgba(217,92,92,0.10)",
  dangerBorder: "rgba(217,92,92,0.24)",

  drag: "#CE8946",
  dragDim: "rgba(206, 137, 70, 0.12)",
  whatsapp: "#25D366",
  yellowCard: "#D89A2B",

  neon: "#CE8946",
  neonGlow: "rgba(206, 137, 70, 0.18)",
  neonDim: "rgba(206, 137, 70, 0.12)",
  neonBorder: "rgba(206, 137, 70, 0.28)",
  green: "#2FA56F",
  greenDim: "rgba(47,165,111,0.10)",
  greenBorder: "rgba(47,165,111,0.24)",
  greenBright: "#D8A06B",
  purple: "#CE8946",
  purpleVibrant: "#D8A06B",
  purpleVibrantDim: "rgba(206, 137, 70, 0.12)",
  purpleVibrantBorder: "rgba(206, 137, 70, 0.28)",
  purpleVibrantGlow: "rgba(206, 137, 70, 0.18)",
  violetAccent: "#B7832D",
  violetDim: "rgba(206, 137, 70, 0.12)",
  violetBorder: "rgba(206, 137, 70, 0.28)",
  violetGlow: "rgba(206, 137, 70, 0.18)",
  violetRing: "rgba(206, 137, 70, 0.22)",
  surfaceHi: "#EDE8D0",
